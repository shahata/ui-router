...
angular.module('fork.ui.router.util').service('$resolve', $Resolve);
...
angular.module('fork.ui.router.util').service('$templateFactory', $TemplateFactory);
...
angular.module('fork.ui.router.util').provider('$urlMatcherFactory', $UrlMatcherFactory);
...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory,           $locationProvider) {
  ...
  function $get(   $rootScope,   $q,   $view,   $injector,   $resolve,   $stateParams,   $location,   $urlRouter,   $browser) {
     ...
     * @example
     * <pre>
     * var app angular.module('app', ['fork.ui.router']);
     *
      ...
      if ($state.$current.toString() === '') {
        ...
        do {
          if (stateChecked.self.needsState) {
            ...
            return $state.transitionTo(stateChecked.self.needsStateDefault,
                                       stateChecked.self.needsStateDefaultParams || {},
                                       { location: false, inherit: true, reload: true })
...
angular.module('fork.ui.router.state').directive('uiView', $ViewDirective);
angular.module('fork.ui.router.state').directive('uiView', $ViewDirectiveFill);
